...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_MEGA_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "incredible power. can up attack."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_NORMAL,
        .accuracy = 90,
    ...
    [MOVE_BIND] =
    {
        ...
        .description = COMPOUND_STRING(
            "Binds the soul of the target\n"
            "to drain HP and trap it."),
    ...
    [MOVE_SLAM] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "tail of energy. Always goes last."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_DRAGON,
        .accuracy = 100,
    ...
    [MOVE_VINE_WHIP] =
    {
        ...
        #endif
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 50 : 35,
        .type = TYPE_GRASS,
        .accuracy = 100,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
    ...
    [MOVE_WRAP] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            BINDING_TURNS" times with vines."),
        .effect = EFFECT_HIT,
        .power = 110,
        .type = TYPE_GRASS,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_5 ? 85 : 85,
        .pp = 20,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
    ...
    [MOVE_THRASH] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 130 : 90,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_FIRE_SPIN] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 90 : 15,
        .type = TYPE_FIRE,
    ...
    [MOVE_SMOG] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "40% chance to poison."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 80 : 20,
        .type = TYPE_POISON,
        .accuracy = 90,
        .pp = 20,
        .target = MOVE_TARGET_BOTH,
    ...
    [MOVE_BONE_CLUB] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Hits flying targets can flinch."),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_GROUND,
        .accuracy = 100,
    ...
    [MOVE_POISON_GAS] =
    {
        ...
        .type = TYPE_POISON,
        .pp = 40,
        .target = B_UPDATED_MOVE_DATA >= GEN_5 ? MOVE_TARGET_BOTH : MOVE_TARGET_BOTH,
        .priority = 0,
        .category = DAMAGE_CATEGORY_STATUS,
        .argument = { .nonVolatileStatus = MOVE_EFFECT_POISON },
        .zMove = { .effect = Z_EFFECT_DEF_UP_1 },
    ...
    [MOVE_WHIRLPOOL] =
    {
        ...
        .description = COMPOUND_STRING(
            "Unleashes a violent whirlpool\n"
            "has a chance to lower speed."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 100 : 15,
        .type = TYPE_WATER,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_5 ? 80 : 70,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_SPECIAL,
    ...
    [MOVE_LUSTER_PURGE] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = (B_UPDATED_MOVE_DATA >= GEN_9) ? 90 : 70,
        .type = TYPE_FAIRY,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_MIST_BALL] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = (B_UPDATED_MOVE_DATA >= GEN_9) ? 85 : 70,
        .type = TYPE_FLYING,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_SAND_TOMB] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 110 : 15,
        .type = TYPE_GROUND,
